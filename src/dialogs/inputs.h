...
private:
	...
	std::unordered_map<QString, QString, util::Hash>	m_codes;
	...
	static std::unordered_map<QString, QString, util::Hash> BuildCodes(const std::vector<status::input_class> &devclasses);
	...
	static QString GetSeqTextFromTokens(const QString &seq_tokens, const std::unordered_map<QString, QString, util::Hash> &codes);
