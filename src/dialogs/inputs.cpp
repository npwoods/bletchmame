...
std::unordered_map<QString, QString, util::Hash> InputsDialog::BuildCodes(const std::vector<status::input_class> &devclasses)
{
	std::unordered_map<QString, QString, util::Hash> result;
...
QString InputsDialog::GetSeqTextFromTokens(const QString &seq_tokens, const std::unordered_map<QString, QString, util::Hash> &codes)
{
