...
std::vector<wxString> RunMachineTask::GetArguments(const Preferences &prefs) const
{
	...
	{
		"-rompath",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::ROMS),
		"-samplepath",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::SAMPLES),
		"-cfg_directory",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::CONFIG),
		"-nvram_directory",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::NVRAM),
		"-hashpath",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::HASH),
		"-artpath",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::ARTWORK),
		"-pluginspath",
		prefs.GetPathWithSubstitutions(Preferences::global_path_type::PLUGINS),
		"-window",
		"-keyboardprovider",
		"dinput",
		"-mouseprovider",
