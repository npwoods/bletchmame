...
void PathsDialog::Test::model()
{
	...
	QStringList samplesPathList1 = prefs.getSplitPaths(Preferences::global_path_type::SAMPLES);
	...
	model.persist();
	QStringList samplesPathList2 = prefs.getSplitPaths(Preferences::global_path_type::SAMPLES);
