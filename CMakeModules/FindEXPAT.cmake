...
set(EXPAT_NAMES expat libexpat)
set(EXPAT_NAMES_DEBUG expatd libexpatd)

find_library(EXPAT_LIBRARY_RELEASE NAMES ${EXPAT_NAMES} NAMES_PER_DIR HINTS ${PC_EXPAT_LIBRARY_DIRS})
find_library(EXPAT_LIBRARY_DEBUG NAMES ${EXPAT_NAMES_DEBUG} NAMES_PER_DIR HINTS ${PC_EXPAT_LIBRARY_DIRS})

if (EXPAT_LIBRARY_RELEASE)
  set(EXPAT_LIBRARY ${EXPAT_LIBRARY_RELEASE})
endif ()
if (EXPAT_LIBRARY_DEBUG)
  set(EXPAT_LIBRARY ${EXPAT_LIBRARY_DEBUG})
endif ()
